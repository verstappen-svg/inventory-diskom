...
Route::middleware('auth')->group(function () {
        ...
        return match ($role) {
            ...
            */
            ...
            'super_admin' => view('dashboard.super-admin', [
                ...
                'totalOperator' => \App\Models\User::where(
                    'role',
                    'operator'
                )->count(),

                'totalVerifikator' => \App\Models\User::where(
                    'role',
                    'verifikator'
                )->count(),

                'totalPimpinan' => \App\Models\User::where(
                    'role',
                    'pimpinan'
                )->count(),
    ...
    */
    ...
    Route::resource(
        ...
        ->except(['show'])
        ->middleware(
            'menu.permission:infrastruktur.jaringan'
        );
    ...
    */
    ...
    Route::resource(
        ...
        ->except(['show'])
        ->middleware(
            'menu.permission:infrastruktur.data-center'
        );
    ...
    */
    ...
    Route::resource(
        ...
        ->except(['show'])
        ->middleware(
            'menu.permission:infrastruktur.splp'
        );
